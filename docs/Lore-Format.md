...
Full-lore mode displays all pages at once and hides separator lines. It is useful when players want to inspect the whole item without clicking through every page.